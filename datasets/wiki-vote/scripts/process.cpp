...
int main(int argc, char ** argv) {
	ifstream fin("../dataset/wiki-Vote.txt");
	ofstream fout_ascii("../dataset/wiki-vote.edgelist");
	ofstream fout_binary("../dataset/wiki-vote.biedgelist");
	...
	ofstream fout_meta("../dataset/wiki-vote.csv");
