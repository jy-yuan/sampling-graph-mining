...
int main(int argc, char ** argv) {
	ofstream fout_ascii("../dataset/simple-10000.edgelist");
	ofstream fout_binary("../dataset/simple-10000.biedgelist");

	srand(time(NULL));
	set<pair<VertexId, VertexId>> used_edges;
	const VertexId num_vertices = 10000;
	const EdgeId num_edges = num_vertices * 16;
	...
	ofstream fout_meta("../dataset/simple-10000.csv");
