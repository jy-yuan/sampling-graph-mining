...
EdgeUnit * edge_list;
const VertexId num_vertices = 65608366;
const EdgeId num_edges = 1806067135;

bool * is_used;
VertexId * mapping;
const VertexId max_vertex_id = 300000000;

int main(int argc, char ** argv) {
	ifstream fin("../dataset/com-friendster.ungraph.txt");
	...
	//ofstream fout_ascii("../dataset/friendster.edgelist");
	ofstream fout_binary("../dataset/friendster.biedgelist");
	...
	ofstream fout_meta("../dataset/friendster.csv");
